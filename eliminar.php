...
<body>
    ...
    $sql = "DELETE FROM tabla36 WHERE codigo='$i'";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <button class="close" onclick="location.href='inventario_eliminar.html'">&times;</button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" onclick="location.href='inventario_eliminar.html'">Cerrar</button>
                </div>
    ...
    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                   Error: No pudimos eliminar ese producto, asegurese de estar digitando bien el Codigo del producto.
